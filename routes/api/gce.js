...
router.get('/gceadmin',function(req,res){
    res.render('gceadmin');
});

router.get('/gcedata',function(req,res){
...
router.post('/gceadmin',function(req,res){
  session=req.session;
...
router.get('/gcelogout',function(req,res){
...
router.get('/gce',function(req,res){
  session=req.session;
...
router.post('/gcenew',function(req,res){
  new gceuser({
...
router.get('/gceuser/:id/edit',function(req,res){
  res.render('gcedataupdate',{gceuser:req.gceuserId});
});

// for updating data
router.post('/gceuser/:id', function(req, res){
...
router.get('/gceuser/:id',function(req,res){
  res.render('gcedata',{gceuser:req.gceuserId});
});
router.get('/gceuser/:id/delete', function(req,res){
