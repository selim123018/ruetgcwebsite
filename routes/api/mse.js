...
router.get('/mseadmin',function(req,res){
    res.render('mseadmin');
});

router.get('/msedata',function(req,res){
...
router.post('/mseadmin',function(req,res){
  session=req.session;
...
router.get('/mselogout',function(req,res){
...
router.get('/mse',function(req,res){
  session=req.session;
...
router.post('/msenew',function(req,res){
  new mseuser({
...
router.get('/mseuser/:id/edit',function(req,res){
  res.render('msedataupdate',{mseuser:req.mseuserId});
});

// for updating data
router.post('/mseuser/:id', function(req, res){
...
router.get('/mseuser/:id',function(req,res){
  res.render('msedata',{mseuser:req.mseuserId});
});
router.get('/mseuser/:id/delete', function(req,res){
