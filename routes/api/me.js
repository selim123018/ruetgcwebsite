...
router.get('/meadmin',function(req,res){
    res.render('meadmin');
});

router.get('/medata',function(req,res){
...
router.post('/meadmin',function(req,res){
  session=req.session;
...
router.get('/melogout',function(req,res){
...
router.post('/menew',function(req,res){
  new meuser({
...
router.get('/meuser/:id/edit',function(req,res){
  res.render('medataupdate',{meuser:req.meuserId});
});

// for updating data
router.post('/meuser/:id', function(req, res){
...
router.get('/meuser/:id',function(req,res){
  res.render('medata',{meuser:req.meuserId});
});
router.get('/meuser/:id/delete', function(req,res){
